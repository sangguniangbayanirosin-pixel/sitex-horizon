...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-WJsNN0sv.mjs");
...
var manifest = {
	"0b23c2db3a3c8d16ae85327ec0e4def83a4b751c992a186ddc27e13c014230c4": {
		functionName: "pushAd_createServerFn_handler",
		importer: () => import("./sync-uD5dOhrf.mjs")
	},
	"283131b13a5cc3801e1d0593454a6c7cf1019085cbd15a5bcd97b2f84fd448de": {
		functionName: "pushWeather_createServerFn_handler",
		importer: () => import("./sync-uD5dOhrf.mjs")
	},
	"5f4c0a298e8fa7b1de3e44b1f89dbcd142a8b96790e34a1b9d457b1e9561f1e3": {
		functionName: "pushAsk_createServerFn_handler",
		importer: () => import("./sync-uD5dOhrf.mjs")
	},
	"63a6bdd16e0cb4559efad9d2d472ea7666dd8aad2434b0d85a3a5840145fa802": {
		functionName: "pushReport_createServerFn_handler",
		importer: () => import("./sync-uD5dOhrf.mjs")
	},
	"77a225f315e4c1cafa4566a82bc8689b110924be8a2032bd5e095d3d7d9f5ef7": {
		functionName: "forwardReport_createServerFn_handler",
		importer: () => import("./sync-uD5dOhrf.mjs")
	},
	"7ec4380fe6e150f9ee16aec92980100953d277258a0442db442cf02fd7b03437": {
		functionName: "pushAnnouncement_createServerFn_handler",
		importer: () => import("./sync-uD5dOhrf.mjs")
	},
	"dc9ae814153b12969a8c8ceab5c27eee3f28861de0dbd972e5a9fe53284d19a5": {
		functionName: "pushBusFix_createServerFn_handler",
		importer: () => import("./sync-uD5dOhrf.mjs")
	},
	"f4d6c6fa48d93281db8f1c64031ccc4443de2fbf4dc38f80f2a11131b0f4d6f9": {
		functionName: "pullLiveFleet_createServerFn_handler",
		importer: () => import("./sync-uD5dOhrf.mjs")
	},
	"ff54cd26aae96580518cdf4a6f8a58c22541fd8da069f7ee566ad2c328b3d904": {
		functionName: "confirmAskRemote_createServerFn_handler",
		importer: () => import("./sync-uD5dOhrf.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-NBrjZWpE.mjs").then((n) => n.t),
